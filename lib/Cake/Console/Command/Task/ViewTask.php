 ...
 * @var array
 */
	public $scaffoldActions = array('top', 'view', 'add', 'edit');
 ...
 */
	public function getOptionParser() {
		...
		$parser->description(
			...
			'help' => __d('cake_console', "Will bake a single action's file. core templates are (top, add, edit, view)")
